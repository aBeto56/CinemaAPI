...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Dec 09. 07:53
...
CREATE TABLE `actors` (
  ...
  `actor_name` varchar(100) COLLATE utf8mb4_hungarian_ci NOT NULL
...
CREATE TABLE `film_type` (
  ...
  `type_name` varchar(100) COLLATE utf8mb4_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
